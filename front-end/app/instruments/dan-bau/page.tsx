      ...
      <section className="px-margin-desktop py-12 max-w-container-max mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter items-center min-h-[60vh]">
          ...
          <div className="md:col-span-7 relative h-[400px] md:h-[600px] w-full rounded-2xl overflow-hidden glass-panel border-t-2 border-primary-container shadow-sm group">
            ...
            <img alt="Dan Bau instrument in warm studio lighting" className="w-full h-full object-cover object-center z-20 relative transition-transform duration-700 group-hover:scale-105" src="https://lh3.googleusercontent.com/aida-public/AB6AXuA5uXYLLTow30NMVEyy9miIwtzjLekhoDrRpVvjKDxpwwPbqzVXMrK1uHkOcU83aXY4OYh4rJBWRbdWnYi74xXGCkRQELG9zwV4hB17Cih-yWzUWtSrBLiAXBjj2M8T2zxB7ndFbOuX81285O4fq_mpO7g13df7wpvqirV4mON4mRl7qr6XfKNnD32hADzbax0Theb-zWLx4imHUMqDEbYiEgsHX1UHsdaA1_SIfEi8FWZ2SMcCDX1TEcvBABDv1dQ5NUbR_e9WkLwI" />
          </div>
        </div>
      </section>
